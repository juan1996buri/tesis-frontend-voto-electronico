        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <div className="layout-main-container">
                <div className="layout-main">
                    ...
                    <Route path={`${path}/instituciones-registradas`} component={Instituciones} />
                    <Route path={`${path}/tipoInstitucion`} component={TipoInstitucion} />
                    <Route path={`${path}/sexos`} component={Sexo} />
                </div>
