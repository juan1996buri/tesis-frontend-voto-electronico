...
const App = () => {
    ...
    useEffect(() => {
        ...
        appService.getUser(1, setInstituto);
    }, []);
    ...
    const menu = [
        ...
        },
        {
            label: "Pages",
            icon: "pi ",
            items: [{ label: "Provincia", icon: "pi pi-fw pi-user-edit", to: "/provincia" }],
        },
        {
            icon: "pi ",
            items: [{ label: "Ciudad", icon: "pi pi-fw pi-user-edit", to: "/ciudad" }],
        },
        {
            icon: "pi ",
            items: [{ label: "Recinto", icon: "pi pi-fw pi-user-edit", to: "/Recinto", state: instituto }],
        },
        {
            icon: "pi ",
            items: [{ label: "Junta", icon: "pi pi-fw pi-user-edit", to: "/Junta", state: instituto }],
        },
        {
            icon: "pi ",
